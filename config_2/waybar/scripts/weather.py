...
location_id = "e95cd0cfcaca01e66d9bc40d719b59123f89709a4b7291b55c50614d1a9ee79a"  # TODO
...
weather_icons = {
    "sunnyDay": "\uf185",  # Sole
    "clearNight": "\uf186",  # Luna
    "cloudyFoggyDay": "\uf0c2",  # Nuvoloso
    "cloudyFoggyNight": "\uf0c2",  # Stessa icona per la notte
    "rainyDay": "\uf73d",  # Pioggia
    "rainyNight": "\uf73d",  # Pioggia di notte
    "snowyIcyDay": "\uf2dc",  # Neve
    "snowyIcyNight": "\uf2dc",  # Neve di notte
    "severe": "\uf0e7",  # Fulmine (severo)
    "default": "\uf0c2",  # Nuvoloso (default)
}
